...
public class Hud implements Disposable {
    ...
    public Hud(SpriteBatch batch) {
        ...
        viewport = new FitViewport(MonkeyWarriors.V_WIDTH, MonkeyWarriors.V_HEIGHT, new OrthographicCamera());
        ...
        monkeyLabel = new Label("SCORE", new Label.LabelStyle(new BitmapFont(), Color.WHITE));

        //add our labels to our table, padding the top, and giving them all equal width with expandX
        table.add(monkeyLabel).expandX().padTop(10);
